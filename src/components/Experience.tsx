              ...
              >
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-orbitron font-semibold text-accent-primary">
                      {exp.title}
                    </h3>
                    <h4 className="text-lg font-semibold text-accent-secondary mt-2">
                      {exp.company}
                    </h4>
                    ...
                    {exp.additionalInfo && (
                      <div className="text-accent-gold mt-2 italic">{exp.additionalInfo}</div>
                    )}
                  </div>
                </div>
